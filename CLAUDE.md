...
- Each future variant (Blazor) will be its own project alongside the existing ones, depending on the same `AgoraFold.Core` (services included), added to `AgoraFold.slnx`.

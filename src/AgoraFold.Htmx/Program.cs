...
// HTMX-issued requests that aren't <form> submits (bare hx-post/hx-delete buttons) carry the
// antiforgery token as a header instead of a hidden form field - see site.js's htmx:configRequest
// listener and _Layout.cshtml's csrf-token meta tag.
